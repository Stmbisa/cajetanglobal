...
class RegistrationForm(RegisterUserCreationForm):
    """
    ...
    email = forms.EmailField(label=_("E-mail, (type the same email here)"))

    class Meta:
        model = User
        fields = ('username','email', 'first_name', 'last_name','gender', 'phone', 'country_of_orgin','country_of_destination', 
        'nationality', 'next_of_kin','next_of_kin_phone_number', 'has_taken_biometry_before',)
        widgets={
            'username': forms.TextInput(attrs={'placeholder':'Type Your EMAIL here(will serve as your USERNAME)',}),
            'first_name': forms.TextInput(attrs={'placeholder':'Your First Name',}),
            'last_name': forms.TextInput(attrs={'placeholder':'Your Last Name',}),
            'next_of_kin': forms.TextInput(attrs={'placeholder':'The Name Of Your Next Of Kin',}),
            'phone': forms.TextInput(attrs={'placeholder':'The phone No. of Your Next of Kin',}),
            'nationality': forms.TextInput(attrs={'placeholder':'What is your Citizenship?',}),
